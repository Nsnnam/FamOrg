...
Kiểm tra `docker-compose.yml` / `.env` trước khi chạy. Mặc định: **local port 3000**, **public port 8443** (cả hai map vào container port 3000). Chi tiết NAS: [NAS-DEPLOY.md](NAS-DEPLOY.md).
...
- Docker path: `/srv/famorg` · SSH port `22`
